      ...
      >
        {otp.map((digit, index) => (
          <input
            ...
            className="h-11 w-11 flex-shrink-0 rounded-lg border border-gray-300 text-center text-base font-semibold outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
          />
        ))}
      </div>
      <Button
      ...
      <div className="text-center">
        {countdown > 0 ? (
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 text-sm text-blue-600 transition hover:text-blue-800 disabled:opacity-60"
          >
            <RotateCw
              size={14}
